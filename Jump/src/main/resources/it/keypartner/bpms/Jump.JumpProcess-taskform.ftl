<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("valid");
					i++;
...
<div id="container">
	<div id="header">
		New Process Instance: /Jump/src/main/resources/it/keypartner/bpms.JumpProcess
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<div class="div_checkbox">
                              		<input name="valid" type="checkbox" class="checkbox" id="valid" value="true" />
                            		</div>
